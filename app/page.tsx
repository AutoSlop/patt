...
export default function Home() {
  return (
    <>
      ...
      {/* HERO */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0a6e55] via-primary to-[#11b48d] text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 text-center">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Veterinarias activas</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-extrabold text-primary">15K+</p>
              <p className="text-sm text-gray-500 mt-1">Citas agendadas/mes</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-extrabold text-primary">62%</p>
              <p className="text-sm text-gray-500 mt-1">Menos citas perdidas</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-extrabold text-primary">4.9/5</p>
              <p className="text-sm text-gray-500 mt-1">Satisfacción promedio</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 bg-bg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-primary font-semibold text-sm tracking-wide uppercase mb-2">El problema</p>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
              ...
              <h3 className="font-bold text-gray-900 text-lg mb-2">Caos en WhatsApp</h3>
            ...
            <div className="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
              ...
              <h3 className="font-bold text-gray-900 text-lg mb-2">Cirugías perdidas por falta de liquidez</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
              ...
              <h3 className="font-bold text-gray-900 text-lg mb-2">Historia clínica fragmentada</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
      ...
      <section id="como-funciona" className="py-16 sm:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-primary font-semibold text-sm tracking-wide uppercase mb-2">Cómo funciona</p>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 mb-4">
          ...
          <div className="grid sm:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div key={item.step} className="text-center relative">
                <div className="w-14 h-14 bg-primary/10 text-primary rounded-2xl flex items-center justify-center text-xl font-extrabold mx-auto mb-5">
                  {item.step}
                </div>
          ...
          <div className="max-w-sm mx-auto">
            <div className="bg-[#ECE5DD] rounded-2xl overflow-hidden shadow-xl border border-gray-200/60 ring-1 ring-black/5">
      ...
      <section id="features" className="py-16 sm:py-24 bg-bg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-primary font-semibold text-sm tracking-wide uppercase mb-2">Funcionalidades</p>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 mb-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
      ...
      <section id="precios" className="py-16 sm:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-primary font-semibold text-sm tracking-wide uppercase mb-2">Precios</p>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 mb-4">
      ...
      <section className="py-16 sm:py-24 bg-bg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-primary font-semibold text-sm tracking-wide uppercase mb-2">Testimonios</p>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 mb-4">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <div key={i} className="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                <div className="bg-primary/10 text-primary text-sm font-bold px-3 py-1.5 rounded-full inline-block mb-5">
                  {t.metric}
                </div>
      ...
      {/* CTA FINAL */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-[#0a6e55] via-primary to-[#11b48d] text-white relative overflow-hidden">
      ...
      {/* FOOTER */}
      <footer className="bg-[#0d1f18] text-gray-400">
          ...
          <div className="grid sm:grid-cols-3 gap-10 sm:gap-8 mb-10">
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-white font-extrabold text-lg">PATT</span>
              </div>
              <p className="text-sm leading-relaxed text-gray-500">
                WhatsApp-native SaaS para veterinarias independientes en Latinoamérica.
              </p>
            </div>
            {/* Product */}
            <div>
