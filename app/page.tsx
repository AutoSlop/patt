...
export default function Home() {
  return (
    <>
      ...
      {/* NAV */}
      <nav className="sticky top-0 z-30 bg-white/80 backdrop-blur-2xl border-b border-gray-100/60 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between h-16 sm:h-[4.25rem]">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 bg-gradient-to-br from-primary to-[#0B7A5E] rounded-xl flex items-center justify-center shadow-sm shadow-primary/15">
            ...
            <span className="text-lg font-extrabold tracking-tight text-text">PATT</span>
          </div>
          <div className="flex items-center gap-3 sm:gap-6 text-[0.8125rem] font-medium text-gray-500">
            ...
            <a
              ...
              className="hidden sm:inline-flex bg-primary hover:bg-primary-dark text-white font-semibold px-4 py-2 rounded-lg transition-colors text-[0.8125rem] shadow-sm shadow-primary/15"
            >
              Habla con nosotros
            </a>
            <a
      ...
      {/* HERO */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#062b22] via-[#085c47] to-[#0F9D7A] text-white">
        <div className="absolute inset-0 bg-grid opacity-[0.12]" />
        <div className="absolute -top-48 -right-48 w-[700px] h-[700px] rounded-full bg-accent/[0.05] blur-[120px]" />
        <div className="absolute bottom-0 -left-40 w-[500px] h-[500px] rounded-full bg-white/[0.02] blur-[100px]" />
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 py-16 sm:py-24 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              {/* Badge */}
              <div className="inline-flex items-center gap-2 bg-white/[0.1] backdrop-blur-sm text-white/90 text-[0.8125rem] font-medium px-4 py-1.5 rounded-full mb-7 border border-white/[0.08]">
                <span className="w-1.5 h-1.5 bg-accent rounded-full animate-pulse-soft" />
                +200 veterinarias en Colombia ya usan PATT
              </div>
              <h1 className="text-[1.75rem] sm:text-[2.75rem] lg:text-[3.25rem] font-extrabold leading-[1.1] tracking-tight">
                Tu veterinaria merece{" "}
                <span className="text-accent">control total en WhatsApp.</span>
              </h1>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                ...
                <a
                  ...
                  data-track="click_whatsapp"
                  data-track-label="hero"
                  className="inline-flex items-center justify-center border-2 border-white/15 hover:bg-white/[0.08] text-white font-semibold px-7 py-3.5 rounded-xl text-base transition-all hover:-translate-y-0.5"
                >
              ...
              <div className="mt-12 grid grid-cols-3 gap-4 max-w-md">
                <div className="text-center">
                  ...
                  <p className="text-[0.7rem] sm:text-xs text-white/50 mt-0.5">Clínicas activas</p>
                </div>
                <div className="text-center border-x border-white/10">
                  <p className="text-2xl sm:text-3xl font-extrabold text-white">62%</p>
                  <p className="text-[0.7rem] sm:text-xs text-white/50 mt-0.5">Menos no-shows</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl sm:text-3xl font-extrabold text-white">48h</p>
                  <p className="text-[0.7rem] sm:text-xs text-white/50 mt-0.5">Implementación</p>
                </div>
              </div>
            </div>
            {/* Lead Form */}
      ...
      <section className="bg-white border-b border-gray-100/50">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-8 sm:py-10">
          <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-[0.8125rem] text-gray-400">
            <span className="font-medium text-gray-500">Confían en nosotros:</span>
            {["Clínica VetAmigo", "PetSalud", "El Buen Pastor", "VetCenter", "PawCare"].map((name) => (
              <span key={name} className="bg-gray-50 px-3 py-1 rounded-full border border-gray-100 font-medium text-gray-400">{name}</span>
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14 sm:py-16">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={stat.label} className="text-center bg-white rounded-2xl p-5 sm:p-6 border border-gray-100/80 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
                <p className="text-2xl sm:text-3xl font-extrabold text-gradient">{stat.value}</p>
                <p className="text-xs sm:text-[0.8125rem] text-gray-400 mt-1 font-medium">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 sm:py-28 bg-bg">
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-14 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-[2.25rem] lg:text-[2.5rem] font-extrabold text-text mt-4 mb-4 leading-tight">
              ¿Te suena familiar?
            </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-5 sm:gap-6">
            {[
              ...
              <div key={item.title} className="card-hover bg-white rounded-2xl p-7 sm:p-8 border border-gray-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.03),0_8px_20px_rgba(0,0,0,0.02)]">
                ...
                <h3 className="font-bold text-text text-[1.0625rem] mb-2.5">{item.title}</h3>
      ...
      <section id="como-funciona" className="py-20 sm:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6 sm:gap-5 mb-20 relative">
            ...
            <div className="hidden sm:block absolute top-8 left-[16.67%] right-[16.67%] h-px bg-gradient-to-r from-primary/15 via-primary/25 to-primary/15" />
            {[
              ...
              <div key={item.step} className="text-center relative z-10 bg-white">
                <div className="w-14 h-14 bg-gradient-to-br from-primary to-[#0B7A5E] text-white rounded-2xl flex items-center justify-center text-lg font-extrabold mx-auto mb-5 shadow-md shadow-primary/15 ring-4 ring-primary/[0.06]">
                  {item.step}
                </div>
                <h3 className="font-bold text-text text-[1.0625rem] mb-2.5">{item.title}</h3>
                <p className="text-gray-400 text-sm leading-relaxed max-w-[280px] mx-auto">{item.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="max-w-sm mx-auto">
            <div className="bg-[#ECE5DD] rounded-2xl overflow-hidden shadow-2xl shadow-black/8 border border-gray-200/40 ring-1 ring-black/[0.03]">
            ...
            <p className="text-center text-[0.8125rem] text-gray-400 mt-5 font-medium">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {[
              ...
              <div key={i} className="card-hover bg-white rounded-2xl p-7 sm:p-8 border border-gray-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.03),0_8px_20px_rgba(0,0,0,0.02)]">
                <div className="icon-box bg-primary/[0.07] mb-5">
                  <svg className="w-6 h-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    {feature.icon}
                  </svg>
                </div>
                <h3 className="font-bold text-text text-[1.0625rem] mb-2.5">{feature.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-5 sm:gap-6">
            {testimonials.map((t, i) => (
              <div key={i} className="card-hover bg-white rounded-2xl p-7 sm:p-8 border border-gray-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.03),0_8px_20px_rgba(0,0,0,0.02)]">
                <div className="bg-primary/[0.07] text-primary text-[0.8125rem] font-bold px-3.5 py-1.5 rounded-full inline-block mb-5">
                  {t.metric}
                </div>
                ...
                <div className="flex items-center gap-3 pt-5 border-t border-gray-100/80">
                  <div className="w-10 h-10 bg-gradient-to-br from-primary/15 to-primary/[0.07] rounded-full flex items-center justify-center">
      ...
      {/* CTA FINAL */}
      <section className="py-20 sm:py-28 bg-gradient-to-br from-[#062b22] via-[#085c47] to-[#0F9D7A] text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-grid opacity-[0.06]" />
        <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-accent/[0.04] blur-[120px]" />
        <div className="relative max-w-3xl mx-auto px-5 sm:px-8 text-center">
          <h2 className="text-2xl sm:text-[2.25rem] lg:text-[2.5rem] font-extrabold mb-4 leading-tight">
            Lleva tu veterinaria al siguiente nivel
          </h2>
          <p className="text-white/60 text-base sm:text-lg mb-9 max-w-lg mx-auto leading-relaxed">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-x-8 gap-y-2 text-sm text-white/40">
      ...
      {/* FOOTER */}
      <footer className="bg-[#071912] text-gray-500">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-6 mb-10">
            ...
            {/* Product */}
            <div>
              <h4 className="text-white font-semibold text-[0.8125rem] mb-4">Producto</h4>
            ...
            {/* Resources */}
            <div>
              <h4 className="text-white font-semibold text-[0.8125rem] mb-4">Recursos</h4>
              <ul className="space-y-2.5 text-sm">
            ...
            {/* Contact */}
            <div>
              <h4 className="text-white font-semibold text-[0.8125rem] mb-4">Contacto</h4>
              <ul className="space-y-2.5 text-sm">
                <li>
                  <a
                    href={WA_URL}
                ...
                <li><span className="text-gray-600">+00 000 000 0000</span></li>
                <li><span className="text-gray-600">123 Main Street</span></li>
              </ul>
            </div>
          </div>
